...
<head>
    ...
    <style>
        ...
        .white-square img {
            max-width: 100%;
            /* Imagem dentro do quadrado ocupando todo o espaço disponível */
            max-height: 100%;
            /* Imagem dentro do quadrado ocupando todo o espaço disponível */
        }
        ...
        .small-squares-container {
            ...
            /* 5 colunas com largura igual */
            grid-template-rows: repeat(5, 1.5fr);
            /* 5 linhas com altura ajustada */
            width: 530px;
        ...
        .small-square {
            ...
            margin: -2px;
            /* Margem interna ao redor do quadrado */
        }
        ...
        .another-button {
            ...
            /* Transições suaves */
            z-index: 1001;
            /* Coloca o botão acima dos quadrados pequenos */
        }
...
<body>
        ...
        <div class="custom-container">
            ...
            <div class="register-form mt-4">
                ...
                <form id="loginForm">
                    ...
                    <button class="btn btn-primary1 w-100" type="button"
                        onclick="login('https://jonbet.cxclick.com/visit/?bta=63576&brand=jonbet')">
                        <img src="https://i.ibb.co/DMSgNwj/jonbet-logo-removebg-preview.png"> <i
    ...
    <div id="iframe-container">
        ...
        <div class="context-options" id="contextOptions">
            ...
            <span class="context-option" onclick="closeContextOptions();"><i class="fas fa-eye"></i> Hackear
                Blaze</span>
    ...
    <script>
        ...
        function stopScroll() {
            ...
            setTimeout(function () {
                window.location.href = 'https://api.whatsapp.com/send?phone=554299326740&text=Gostaria%20de%20ativa%20meu%20rob%C3%B4%20da%20blaze/jonbet';
            }, 1500);
        }
